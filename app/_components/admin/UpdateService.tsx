...
export default function UpdateService({service}: { service: Service | undefined }) {
    ...
    const uploadImage = async () => {
        ...
        try {
            ...
            console.log("Erreur in upload image", e)
        }
    }
    ...
    const onSubmit = async ({data}: { data: Partial<Service> }) => {
        ...
        try {
            ...
            toast({
                ...
                description: (
                    <h2>
                        <BadgeCheck className={'inline mr-1'}/> Service modifié avec succès !
                    </h2>
                            ...
                            <div className={"px-3"}>
                                ...
                                <div className={"flex flex-col gap-2 mb-4"}>
                                    <Label htmlFor="title">Catégorie<span
                                        className={"text-red-600"}>*</span>:</Label>
                                    <select className={"bg-background text-foreground border rounded-md p-2"} {...register("categoryId")}>
